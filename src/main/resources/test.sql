...
CREATE TABLE `food` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `applicant` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `coordinates` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
`address` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
`fooditems` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
